...
activities = {
    ...
    "Swimming Club": {
        ...
        "max_participants": 16,
        "participants": ["linda@mergington.edu", "mark@mergington.edu"]
    },
    "Art Club": {
        "description": "Explore drawing, painting, and mixed media projects",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["nina@mergington.edu", "peter@mergington.edu"]
    },
    "Drama Club": {
    ...
    "Debate Team": {
        "description": "Practice forming arguments and compete in debate tournaments",
